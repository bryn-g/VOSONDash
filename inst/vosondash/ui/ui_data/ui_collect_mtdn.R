            ...
            fluidRow(
              tabBox(title = NULL, id = "mtdn_collect_tabset", width = 12,
                     tabPanel(
                       "Search",
                       textInput(
                         "mtdn_search_hashtag_text",
                         label = "Hashtag",
                         value = "",
                         width = "75%"
                       ),
                       textInput(
                         "mtdn_search_instance_text",
                         label = "Instance",
                         value = "mastodon.social",
                         width = "50%"
                       ),
                       selectInput(
                         "mtdn_search_timeline_sel",
                         "Timeline",
                         list("global", "local"),
                         width = "100px"
                       ),
                       numericInput(
                         "mtdn_search_count_num",
                         label = "Count",
                         value = 100,
                         min = 1,
                         width = "90px"
                     ...
                     tabPanel(
                       ...
                       div(textInput(
                         "mtdn_thread_url_text", label = NULL, value = ""
                       )),
                       ...
                       conditionalPanel(
                         ...
                         div(
                           actionButton("mtdn_thread_rm_url_btn", label = "Remove"),
           ...
           fluidRow(
             tabBox(
               ...
               title = div(
                 ...
                 span(
                   icon("mastodon", class = "mastodon_red"),
                   "Mastodon Network Collection"
                 )
               ),
               tabPanel(
                 "Console",
