          ...
          column(
            ...
            fluidRow(
              sidebarPanel(
                ...
                hr(),
                disabled(
                  checkboxInput("ta_twitter_hashtags_check", "Remove Twitter hashtags", TRUE)
                ),
                disabled(
                  checkboxInput("ta_twitter_usernames_check", "Remove Twitter usernames", TRUE)
                ),
                sliderInput(
                   ...
                   tabBox(
                     ...
                     tabPanel("Sentiment",
                              fluidRow(column(
                                width = 12,
                                div(
                                  "Analysis uses the Syuzhet Package - NRC Emotion Lexicon (Saif Mohammad)",
                                  style = "margin-left:15px;"
                                )
                              )),
                              fluidRow(column(
                                width = 12, taPlotContainerUI("word_sentiments")
                              )))
                   )
                 ))
        ))
