  ...
  fluidRow(
    column(width = 3, offset = 0,
      ...
      fluidRow(
        ...
        # collect tab set          
        tabBox(title = NULL, id = "youtube_control_tabset", width = 12,
          ...
          tabPanel("Collect Data",
            ...
            # video url input
            div(
              tags$b("Add Youtube URL"), 
              po_info(i_ytbe_video_url), 
              style = "margin-bottom:5px;"
            ),
            textAreaInput("youtube_video_id_input", label = NULL, value = "", width = NULL, height = NULL, cols = NULL,
              rows = 2, placeholder = NULL, resize = "vertical"),
            ...
            # number of comments
            ui_inline_input("Max Comments",
              numericInput("youtube_max_comments_input", label = NULL, value = 200, min = 1, width = "90px")
            ),
          ...
          tabPanel("Create Network",
            ...
            conditionalPanel(condition = "input.youtube_network_type_select == 'actor'",
