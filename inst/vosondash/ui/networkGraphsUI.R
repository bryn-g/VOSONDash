...
tabItem(tabName = "network_graphs_tab",
        fluidRow(
          column(width = 3, offset = 0,
                 fluidRow(
                         tabBox(title = NULL,
                                id = "network_graphs_control_tabset",
                                width = 12,
                                tabPanel("File",
                                ...
                                tabPanel("Nodes",
                                         ...
                                         div(""),
                                         div(disabled(checkboxInput("graph_isolates_check", "Isolates", TRUE))),
                                         fluidRow(
                                                 column(width = 6,
                                ...
                                tabPanel("Edges",
                                         div(disabled(checkboxInput("edge_labels_check", "Use Labels", FALSE)), class = "div_inline"),
                                         conditionalPanel(condition = 'input.edge_labels_check',
                                                          fluidRow(column(width = 6, shinyjs::disabled(selectInput("edge_label_select", label = NULL,
                                                                                                                   choices = c("None"), selected = "None", multiple = FALSE))))
                                         ),
                                         div(""),
                                ...
                                tabPanel("Layout",
                                         ...
                                         div("Reseed", style = "font-weight: bold;", class = "div_inline"),
