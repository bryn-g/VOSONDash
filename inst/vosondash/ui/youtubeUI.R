...
tabItem(tabName = "youtube_collection_tab",
            ...
            fluidRow(
              ...
              tabBox(
                ...
                tabPanel(
                  ...
                  div(
                    div("Max Comments", class = "div_inline", style = "padding-bottom:10px;padding-right:10px;"),
                    div(
                      numericInput(
                        "youtube_max_comments_input",
                        label = NULL,
                        value = gbl_def_youtube_count,
                        min = 1,
                        width = "90px"
                      ),
                      class = "div_inline"
            ...
            fluidRow(
              tabBox(
                ...
                title = div(
                  ...
                  span(
                    icon("youtube", class = "youtube_red"),
        ...
        fluidRow(# youtube collection data table
          tabBox(
            width = 12,
            title = "Youtube Data",
            tabPanel(
              ...
              fluidRow(
                ...
                div(
                  checkboxInput("dt_youtube_truncate_text_check", "Truncate text", TRUE),
                  class = "div_inline"
                )
              ),
