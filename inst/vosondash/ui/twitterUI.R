...
tabItem(tabName = "twitter_collection_tab",
                        ...
                        fluidRow(
                                ...
                                tabBox(
                                        ...
                                        tabPanel(
                                                ...
                                                div(
                                                        div("Count", class = "div_inline", style = "padding-bottom:10px;padding-right:10px;margin-right:28px;"),
                                                        div(
                                                                numericInput(
                                                                        "twitter_tweet_count_input",
                                                                        label = NULL,
                                                                        value = gbl_def_tweet_count,
                                                                        min = 1,
                                                                        width = "90px"
                                                                ),
                                                                class = "div_inline"
                                                ...
                                                div(
                                                        div("Date Until", class = "div_inline", style = "padding-bottom:10px;padding-right:16px;"),
                                                        div(suppressWarnings(
                                                                dateInput(
                                                                        "twitter_date_until_input",
                                                                        label = NULL,
                                                                        value = "",
                                                                        min = NULL,
                                                                        max = NULL,
                                                ...
                                                checkboxInput(
                                                        'expand_twitter_id_filters_check',
                                                        div(
                                                                "Tweet ID Range",
                                                                vpopover(po_twit_id_range()$title, po_twit_id_range()$content),
                                                                class = "div_inline"
                                                        ),
                                                        FALSE
                                                ),
                                                conditionalPanel(condition = 'input.expand_twitter_id_filters_check',
                                                                 div(
                                                                         div("Since ID", class = "div_inline", style = "padding-bottom:10px;padding-right:10px;"),
                                                                         div(
                                                                                 textInput(
                                                                                         "twitter_since_id_input",
                                                                                         label = NULL,
                                                                                         value = "",
                                                                                         width = "110px"
                                                                                 ),
                                                                 ...
                                                                 div(
                                                                         div("Max ID", class = "div_inline", style = "padding-bottom:10px;padding-right:20px;"),
                                                                         div(
                                                                                 textInput(
                                                                                         "twitter_max_id_input",
                                                                                         label = NULL,
                                                                                         value = "",
                                                                                         width = "110px"
                                                                                 ),
                                                ...
                                                conditionalPanel(
                                                        condition = 'input.expand_twitter_filters_check',
                                                        div(
                                                                div("From User:", class = "div_inline", style = "padding-bottom:10px;padding-right:10px;"),
                                                                div(
                                                                        textInput(
                                                                                "twitter_filter_from",
                                                                                label = NULL,
                                                        ...
                                                        div(
                                                                div("To User:", class = "div_inline", style = "padding-bottom:10px;padding-right:10px;margin-right:19px;"),
                                                                div(
                                                                        textInput(
                                                                                "twitter_filter_to",
                                                                                label = NULL,
                                        ...
                                        tabPanel(
                                                "Create Network",
                                                selectInput(
                                                        "twitter_network_type_select",
                                                        label = "Network",
                                                        choices = c("activity", "actor", "twomode", "semantic"),
                                                        multiple = FALSE
                                                ),
                                                conditionalPanel(
                        ...
                        fluidRow(
                                tabBox(
                                        ...
                                        title = div(
                                                ...
                                                span(
                                                        icon("twitter", class = "twitter_blue"),
        ...
        fluidRow(# twitter collection data table
                tabBox(
                        width = 12,
                        title = "Twitter Data",
                        tabPanel(
                                ...
                                fluidRow(
                                        div(
                                                checkboxInput('expand_show_twitter_cols', 'Column filters', FALSE),
                                                style = "margin-left:12px; margin-right:5px;",
                                                class = "div_inline"
                                        ),
                                        div(
                                                checkboxInput("dt_twitter_truncate_text_check", "Truncate text", TRUE),
                                                class = "div_inline"
                                        )
                                ),
