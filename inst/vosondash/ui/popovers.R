po_reseed_graph <- function() {
  title <- "Re-seed Graph"
  content <-
    "Generate a new random number to seed the graph layout."
...
po_graph_layout <- function() {
  ...
  content <-
    paste0(
      "Select a network layout for the graph.<br><br>",
...
po_cat_filter <- function() {
  ...
  content <-
    paste0(
      "Categorical variables are identified by graph vertex attributes with names that begin with the ",
...
po_twit_query <- function() {
  ...
  content <-
    paste0(
      "A range of search operators and filters can be used in the <code>Search Query</code> input. ",
...
po_twit_id_range <- function() {
  ...
  content <-
    paste0(
      "Set the bounds of a search. <code>Since ID</code> requests the twitter API to return only ",
...
po_twit_lang <- function() {
  ...
  content <-
    paste0(
      "Requests the twitter API to return tweets in the language entered as two character ",
...
po_twit_results <- function() {
  ...
  content <-
    paste0(
      "Requests the twitter API to return tweets of the following result types.<br><br>",
...
po_twit_assoc <- function() {
  ...
  content <-
    paste0(
      "<code>Limited</code> option includes only ties between most frequently ",
...
po_yt_url <- function() {
  ...
  content <-
    paste0(
      "Enter a Youtube video URL in either long or short format.<br><br>",
...
po_red_url <- function() {
  ...
  content <-
    paste0(
      "Enter a Reddit thread URL in the following format.<br><br>",
      "<i class = 'fa fa-angle-right'></i>&nbsp;&nbsp;",
...
po_web_auth <- function() {
  ...
  content <-
    paste0(
      "This token creation method is interactive and will open a web browser tab to twitter asking you ",
