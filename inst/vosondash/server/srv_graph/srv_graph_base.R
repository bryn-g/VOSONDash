...
#     # ----
#     
#     g <- filter_nodesSrv(g, g_rv$prune_nodes)
#     g <- filter_cats(g, input$cat_sel, input$cat_sub_sel)
#     # isolate as comp_mode_sel has event
#     g <- filter_comps(g, isolate(input$comp_mode_sel), input$comp_slider)    
#     g <- filter_edges(g, input$fltr_iso_chk, input$fltr_edge_multi_chk, 
